...
## Introduction
BigMemory Max uses the Ehcache interface, of which Cache is an implementation. It is possible and encouraged
...
Note that decorators can be configured against the `defaultCache`. This is very useful for frameworks
...
These are decorated. See [Cache Exception Handlers](/documentation/4.1/bigmemorymax/api/cache-exception-handlers) for full details.
