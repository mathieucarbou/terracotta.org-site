 ...
 * Terracotta Server 4.4.x (Open Source version)
 * Ehcache 2.11.x (Open Source version)
 ...
 * Terracotta Server 4.4.x (Enterprise version)
 * Ehcache 2.11.x (Enterprise version)

Get a free trial of BigMemory Max 4.4.x here:

> https://tech.forums.softwareag.com/pub/terracotta-big-memory-max-download-form[BigMemory Max 4.4.x]
...
> https://tech.forums.softwareag.com/pub/terracotta-big-memory-go-download-form[BigMemory Go 4.4.x]
